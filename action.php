<?php
session_start();
//https://english.hi.is/mechanical_engineering
...
//Count comment total unlikes
 ...
 $output .= '
     ...
     <div class="hideComment'.$row["comment_id"].'">
      <h6 style="color:black;"  >@'.$row["username"].' <span class="comment-dates"><i class="fa fa-circle" style="font-size:7px;" aria-hidden="true"></i>
