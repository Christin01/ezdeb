...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>EZ-DEB || ADMIN</title>
	
	<link href="vendor/jquery-nice-select/css/nice-select.css" rel="stylesheet">
	<link rel="stylesheet" href="vendor/nouislider/nouislider.min.css">
	<!-- Style css -->
    <link href="adminhome/Dashborad/css/style.css" rel="stylesheet">
...
<body>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header" style="background-color:#fff;">
            <a href="index.html" class="brand-logo">
				...
				<p class="brand-title" width="124px" height="33px"  style="font-size: 30px;">EZ-DEB</p>
            </a>
        ...
        ***********************************-->
        ...
        <!--**********************************
            Sidebar start
        ***********************************-->
        <div class="dlabnav" style="background-color:#fff;">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					<li class="dropdown header-profile">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							<img src="adminhome/Dashborad/images/ion/man (1).png" width="20" alt=""/>
                    ...
                    <li><a href="viewpack.php" aria-expanded="false">
							<i class="flaticon-025-dashboard"></i>
							<span class="nav-text">PACKAGES</span>
						</a>
                    </li>
                    <li><a href="viewcat.php" aria-expanded="false">
						<i class="flaticon-050-info"></i>
							<span class="nav-text">CATEGORIES</span>
						</a>
                    </li>
                    <li><a href="viewmissing.php" aria-expanded="false">
							<i class="flaticon-041-graph"></i>
							<span class="nav-text">MISSING REQUESTS</span>
						</a>
                    </li>
                    <li><a href="viewbot.php" aria-expanded="false">
							<i class="flaticon-086-star"></i>
							<span class="nav-text">Bot</span>
						</a>
                    </li>
                    <li><a href="viewnotans.php" aria-expanded="false">
							<i class="flaticon-045-heart"></i>
							<span class="nav-text">BOT NOT ANSWERED</span>
						</a>
                    </li>
                    <li><a href="viewreport.php" class="ai-icon" aria-expanded="false">
							<i class="flaticon-013-checkmark"></i>
							<span class="nav-text">REPORTED</span>
						</a>
					</li>
                    <li><a href="viewuser.php" aria-expanded="false">
							<i class="flaticon-072-printer"></i>
							<span class="nav-text">USERS</span>
						</a>
                    </li>
					
                    <li><a href="adminlogout.php" aria-expanded="false">
        ...
        ***********************************-->
		...
		<?php
						...
						$db = mysqli_select_db($connection, 'ezdeb');       
                              $r="SELECT * FROM reports WHERE status= '' ";
                             $e=mysqli_query($connection,$r);
                             $b=mysqli_num_rows($e); 

                            $t="SELECT * FROM reports_reply WHERE status= '' ";
                             $e1=mysqli_query($connection,$t);
                             $b1=mysqli_num_rows($e1); 
                             
                             $t2="SELECT * FROM tbl_comment_post  ";
                             $e2=mysqli_query($connection,$t2);
                             $b2=mysqli_num_rows($e2); 

                             $t3="SELECT * FROM tbl_reply  ";
                             $e3=mysqli_query($connection,$t3);
                             $b3=mysqli_num_rows($e3); 
                             
							 $t4="SELECT * FROM users WHERE type=1";
                             $e4=mysqli_query($connection,$t4);
                             $b4=mysqli_num_rows($e4); 

							 $t5="SELECT * FROM users WHERE type=2";
                             $e5=mysqli_query($connection,$t5);
                             $b5=mysqli_num_rows($e5); 

							 $t6="SELECT * FROM misspck";
                             $e6=mysqli_query($connection,$t6);
                             $b6=mysqli_num_rows($e6); 

							 $t7="SELECT * FROM category";
                             $e7=mysqli_query($connection,$t7);
                             $b7=mysqli_num_rows($e7);

							 $t8="SELECT * FROM package";
                             $e8=mysqli_query($connection,$t8);
                             $b8=mysqli_num_rows($e8);
					...
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						<div class="card bg-warning invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"><?php echo $b8; ?> </h2>
									<span class="text-white fs-18">Total Packages</span>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"><?php echo $b7; ?> </h2>
					...
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						<div class="card bg-info invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"><?php echo $b; ?></h2>
									<span class="text-white fs-18">Reported Comments</span>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						<div class="card bg-secondary invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"><?php echo $b1; ?> </h2>
									<span class="text-white fs-18">Reported Replies</span>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="row align-items-center">
									<div class="col-xl-6">
										<div class="card-bx bg-blue">
											<img class="pattern-img" src="adminhome/Dashborad/images/pattern/pattern6.png" alt="">
											<div class="card-info text-white">
												<img src="adminhome/Dashborad/images/pattern/circle.png" class="mb-4" alt="">
												<h2 class="text-white card-balance"><?php echo $b6; ?> </h2>
												<p class="fs-16">MISSING PACKAGES REQUESTS</p>
										...
										<div class="row  mt-xl-0 mt-4">
											<div class="col-md-12">
												...
												<ul class="card-list mt-4">
													<li><span class="bg-blue circle"></span>ADMIN<span><?php echo $b5; ?> </span></li>
													<li><span class="bg-success circle"></span>Users<span><?php echo $b4; ?> </span></li>
													<li><span class="bg-warning circle"></span>Comments<span><?php echo $b2; ?> </span></li>
													<li><span class="bg-light circle"></span>Replies<span><?php echo $b3; ?> </span></li>
												</ul>
											</div>
        ...
        ***********************************-->
        <div class="footer">
            ...
            <div class="copyright">
                <p>© CREATED&amp; by <a href="#" target="_blank">EZ-DEB</a> 2022</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="adminhome/Dashborad/vendor/global/global.min.js"></script>
	<script src="adminhome/Dashborad/vendor/chart.js/Chart.bundle.min.js"></script>
	<script src="adminhome/Dashborad/vendor/jquery-nice-select/js/jquery.nice-select.min.js"></script>
	
	<!-- Apex Chart -->
	<script src="adminhome/Dashborad/vendor/apexchart/apexchart.js"></script>
	<script src="adminhome/Dashborad/vendor/nouislider/nouislider.min.js"></script>
	<script src="adminhome/Dashborad/vendor/wnumb/wNumb.js"></script>
	
	<!-- Dashboard 1 -->
	<script src="adminhome/Dashborad/js/dashboard/dashboard-1.js"></script>

    <script src="adminhome/Dashborad/js/custom.min.js"></script>
	<script src="adminhome/Dashborad/js/dlabnav-init.js"></script>
	<script src="adminhome/Dashborad/js/demo.js"></script>
    <script src="adminhome/Dashborad/js/styleSwitcher.js"></script>
