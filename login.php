...
if (isset($_SESSION['admin'])) {
   ...
   // <script type="text/javascript"> window.setTimeout(function() { window.location.href='adproduct.php'; }, 1000); </script>
	 header('Refresh:0.5;adminhome.php');
	die();
  }
?>
...
<body>
	<img class="wave" src="imgl/wave.png">
	<div class="container">
		<div class="img">
			<img src="imgl/bg.svg">
		</div>
...
if($conn->connect_error) {
 ...
 if(isset($_POST['submit'])){
    ...
    $sql = "SELECT *from users where email = '$username' AND  password='$h_password' AND type=2";
    ...
    if($count == 1){  
       ...
       //header('Refresh:0.1; adminhome.php');?>
     <script> location.replace("adminhome.php"); </script>
    <?php
    }
    else{  
