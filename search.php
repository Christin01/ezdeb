...
{ 
    echo ("<script>location.href = 'packagelist.php';</script>");
...
<div class="row">  
 ...
 <select   id="products" name="products" class="form-select my-5  w-auto" >
            ...
            <form action="search.php" method="post" class="navbar-form ms-auto input-group my-5 w-auto h-10" role="search" id="navBarSearchForm">
               ...
               <button type="submit" class="btn btn-primary rounded-left">search</button>
...
if(isset($_POST["search"]))
{
    $se=$_POST['search_text'];
	$search = mysqli_real_escape_string($connect, $se);
	$query = "
	SELECT * FROM package 
